...
type Entry = { id: string; label: string; price: string; sortOrder: string };
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
    ...
    const items: Entry[] = data.data.metaobjects.edges
        .map((edge: any) => {
            ...
            return { id: edge.node.id, category: f.category, label: f.label || "", price: f.price_decimal || "0", sortOrder: f.sort_order || "0" };
        })
            ...
            <s-section heading="Add New Add-on">
                ...
                <fetcher.Form method="post">
                    ...
                    <s-stack direction="inline" gap="base">
                        <input type="text" name="label" placeholder="Label (e.g. Extra Installation Day)" required />
                        <input type="number" step="0.01" name="price" placeholder="Extra Price" defaultValue="0" required />
